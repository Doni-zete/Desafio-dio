...
então será que você pode ajudá-los? Com base no número total de coxinhas consumidas
 e o número de participantes na competição, 
 o dono do restaurante precisa que você desenvolva um programa para
  saber a quantidade média de coxinha que os participantes da competição conseguem devorar.
...
indicando respectivamente o número total de coxinhas consumidas
...
var linha = gets().split(" ");

var H = parseInt(linha[0]);
var P = parseInt(linha[1]);

var media = (H/P).toFixed(2);
