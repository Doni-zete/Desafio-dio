/* Na geometria Euclidiana, um polígono regular é um polígono em
 que todos os ângulos são iguais e todos os lados tem o mesmo comprimento.
...
class Problem
{
  ...
  static void Main(string[] args)
  {
    ...
    string[] recebeValor = Console.ReadLine().Split(' ');
    int X = int.Parse(recebeValor[0]);
    int Y = int.Parse(recebeValor[1]);
