...
Ele tem percebido que para as pipas possuírem maior estabilidade, 
e dessa forma voarem mais alto, elas devem possuir um barbante bem
 esticado ligando todos os pares de pontas não vizinhas.
...
class TESTE {
    ...
    static void Main(string[] args) { 
        ...
        long resposta = ((numero * (numero - 3)) / 2);  //Digite sua lógica aqui
